...
def run_generation_pipeline(req, *, allowed_topologies=None, excluded_topologies=None, explain_topology_selection=False):
    ...
    return {"normalized": normalized.model_dump(), "issues": v["issues"], "missing": v["missing"], "conflicts": v["conflicts"], "candidates": ranked, "assumptions": assumptions, "policy_version": policy.version, "topology_selection_trace": selection if explain_topology_selection else {}, "topology_candidate_stats": topology_stats}
